...
replace n_pospro_1 = 0 if ( n_pospro_1 ==.)
...
replace n_pospro_2 = 0 if ( n_pospro_2 ==.)
...
/*Generate the Area variable : Nord-ovest : Piemonte, Valle d'Aosta, Lombardia, Liguria; == 1; Nord-est: Trentino-Alto Adige, Veneto, Friuli-Venezia Giulia, Emilia-Romagna; ==2; Centro: Toscana, Umbria, Marche, Lazio; == 3; Sud: Abruzzo, Molise, Campania, Puglia, Basilicata, Calabria; == 4 ; Isole : Sicilia, Sardegna*/
